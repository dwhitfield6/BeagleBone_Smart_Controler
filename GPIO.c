...
void Init_GPIO(void)
{
	...
	HWREG(SOC_CONTROL_REGS + CONTROL_CONF_MCASP0_AHCLKR) = PAD_FS_RXE_PU_PUPDE(3);	// CS0  = pin C12
	...
	/*~~~~~~~~~~~~~~~~~~~ FRAM module ~~~~~~~~~~~~~~~~~~~*/
    /* set up the pins */
	HWREG(SOC_CONTROL_REGS + CONTROL_CONF_UART_RTSN(1)) = PAD_FS_RXE_PU_PUPDE(4);	// CS1  = pin D17
